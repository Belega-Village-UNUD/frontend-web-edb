...
const CartList = () => {
  ...
  return (
    <div className="mx-auto max-w-2xl pt-10  sm:px-6 lg:max-w-7xl lg:px-20">

      <div className="space-y-2 px-4 sm:flex sm:items-baseline sm:justify-between sm:space-y-0 sm:px-0">
        <div className="flex sm:items-baseline sm:space-x-4">
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Shopping Chart keren</h1>
        </div>
      </div>

      <div className='bg-white shadow-sm mt-4'>
        <div className='p-5 text-center text-base font-medium lg:grid lg:grid-cols-6'>
        ...
        <div className="border-b border-t border-gray-200 bg-white shadow-sm sm:rounded-lg sm:border">
          ...
          {products.map((product) => (
            ...
            <div key={product.id} className="p-4 flex border-b border-gray-200 lg:grid lg:grid-cols-6 lg:place-content-center">
              <div className="pr-4 aspect-h-1 aspect-w-1 w-full h-fit flex-shrink-0 overflow-hidden rounded-lg sm:aspect-none sm:h-40 sm:w-40">
                <Image
