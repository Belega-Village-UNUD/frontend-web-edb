      ...
      <div className="my-20 bg-white shadow-sm ring-1 ring-gray-900/5 md:rounded-lg">
        <ProgressBar
          ...
          steps={[
            {
              id: "01",
              name: "Name Form Store",
              description:
                "Enter your personal details such as name, date of birth, etc.",
              href: "#",
            },
            {
              id: "02",
        ...
        <div className="p-12">
          ...
          {currentStep === "01" && (
            <NameFormStore onNameFormSubmit={handleNameFormSubmit} />
          )}
          {currentStep === "02" && (
            <AddressFormStore onAddressFormSubmit={handleAddressFormSubmit} />
          )}
          {currentStep === "03" && (
            <FileFormStore onFileFormSubmit={handleAddressFormSubmit} />
          )}
        </div>
      </div>
    </Container>
