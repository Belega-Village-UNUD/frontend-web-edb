...
const NewBankListStore = () => {
  ...
  const handleCreateNewBank: SubmitHandler<any> = useCallback(
    async (data: any) => {
      ...
      <div className="lg:-mx-8 lg:mb-2 sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="text-sm text-gray-500">
            Create a new bank account in your store
          </p>
        </div>
      </div>
      <div className="mt-8 flow-root">
        <div className="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
          <form onSubmit={handleSubmit(handleCreateNewBank)}>
...
export default NewBankListStore;
