...
function Payment() {
  return (
    <div className="px-3 md:w-5/12">
      ...
      <div>
        <button className="block w-full mx-auto border border-transparent bg-green hover:bg-lime-950 bg-lime-900 focus:bg-lime-950 text-white rounded-md px-3 py-2 font-semibold">
          PAY NOW
        </button>
      </div>
    </div>
