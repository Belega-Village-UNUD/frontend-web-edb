...
const ButtonConfirm = forwardRef<HTMLButtonElement, ButtonConfirmProps>(
  (
    ...
    ${outline ? "bg-green-50" : "bg-lime-900"} ${
          outline ? "hover:bg-lime-900" : "hover:bg-green-50"
        } ${outline ? "text-lime-900" : "text-green-50"} ${
          outline ? "hover:text-green-50" : "hover:text-lime-900"
        } 
